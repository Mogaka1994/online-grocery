        ...
        <div class="w3ls_w3l_banner_nav_right_grid">
            ...
            <div class="w3ls_w3l_banner_nav_right_grid_head_grids">
                <div class="col-md-4 w3ls_w3l_banner_nav_right_grid_head_grid">
                    ...
                    <h4>Bread & Bakery</h4>
                    <ul>
                        <li><a href="fruits.php">Raising rolls</a></li>
                        <li><a href="fruits.php">Butter Croissants</a></li>
                        <li><a href="fruits.php">wheat pita</a></li>
                        <li><a href="fruits.php">Hot dog roll</a></li>
                    </ul>
                </div>
                <div class="col-md-4 w3ls_w3l_banner_nav_right_grid_head_grid">
                            ...
                            <figure>
                                <div class="snipcart-item block" >
                                    <div class="snipcart-thumb">
                                        ...
                                        <h4>Ksh7.99 <span>Ksh10.00</span></h4>
                                    </div>
                            ...
                            <figure>
                                <div class="snipcart-item block" >
                                    <div class="snipcart-thumb">
                                        ...
                                        <h4>Ksh11.99 <span>Ksh15.00</span></h4>
                                    </div>
                                    <div class="snipcart-details top_brand_home_details">
                                        <form action="#" method="post">
                                            <fieldset>
                            ...
                            <figure>
                                <div class="snipcart-item block">
                                    <div class="snipcart-thumb">
                                        ...
                                        <h4>Ksh8.00 <span>Ksh10.00</span></h4>
                                    </div>
                                    <div class="snipcart-details top_brand_home_details">
                                        <form action="#" method="post">
                                            <fieldset>
                            ...
                            <figure>
                                <div class="snipcart-item block">
                                    <div class="snipcart-thumb">
                                        ...
                                        <p>dogs food (4 Kg)</p>
                                        <h4>Ksh9.00 <span>Ksh11.00</span></h4>
                                    </div>
                                    <div class="snipcart-details top_brand_home_details">
                                        <form action="#" method="post">
                                            <fieldset>
