...
if(!empty($_GET["action"])) {
    switch($_GET["action"]) {
        case "add":
            ...
            if($result){
                $response ="<div class='alert alert-success'>Product Added to Cart Successfully <a href='checkout.php'class='btn btn-xs btn-success'>Click to Checkout</a> </div>";
            }else{
...
<div class="newsletter">
    <div class="container">
        ...
        <div class="w3agile_newsletter_right">
            <form action="fruits.php" method="post"><?php echo $response;?>
